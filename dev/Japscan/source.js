...
const JapscanParsing_1 = require("./JapscanParsing");
const UrlJapscan_1 = require("./UrlJapscan");
const method = 'GET';
...
exports.JapscanInfo = {
    ...
    description: 'Extension that pulls manga from Japscan, includes Search and Updated manga fetching',
    hentaiSource: false,
    websiteBaseURL: UrlJapscan_1.ML_DOMAIN,
    sourceTags: [
        {
            text: "Notifications",
...
class Japscan extends paperback_extensions_common_1.Source {
    ...
    getMangaShareUrl(mangaId) { return `${UrlJapscan_1.ML_DOMAIN}/manga/${mangaId}`; }
    getMangaDetails(mangaId) {
        return __awaiter(this, void 0, void 0, function* () {
            const request = createRequestObject({
                url: `${UrlJapscan_1.ML_DOMAIN}/manga/`,
                method,
                headers,
                param: mangaId + '/'
            });
            ...
            return JapscanParsing_1.parseMangaDetails($, mangaId);
        });
    }
    getChapters(mangaId) {
        var _a;
        return __awaiter(this, void 0, void 0, function* () {
            ...
            const chapterRequest = (_a = response.data.match(re)) !== null && _a !== void 0 ? _a : [];
            const responseArray = [];
            for (let i = 1; i < chapterRequest.length; i++) {
                const requestChapter = createRequestObject({
                    url: `${UrlJapscan_1.ML_DOMAIN}${chapterRequest ? chapterRequest[i] : ''}`,
                    method,
                    headers,
                });
                if (chapterRequest)
            ...
            return JapscanParsing_1.parseChapters(responseArray, mangaId);
        });
    }
    getChapterDetails(mangaId, chapterId) {
        return __awaiter(this, void 0, void 0, function* () {
            ...
            const response = yield this.requestManager.schedule(request, 3);
            const $ = this.cheerio.load(response.data);
            return JapscanParsing_1.parseChapterDetails($, mangaId, chapterId);
        });
    }
    filterUpdatedManga(mangaUpdatesFoundCallback, time, ids) {
        return __awaiter(this, void 0, void 0, function* () {
            const request = createRequestObject({
                url: `${UrlJapscan_1.ML_DOMAIN}/`,
                headers,
                method,
            });
            let data = yield this.requestManager.schedule(request, 3);
            let $ = this.cheerio.load(data.data);
            let updatedManga = JapscanParsing_1.parseUpdatedManga($, time, ids);
    ...
    searchRequest(query, _metadata) {
        return __awaiter(this, void 0, void 0, function* () {
            const metadata = JapscanParsing_1.searchMetadata(query);
            const request = createRequestObject({
                url: `${UrlJapscan_1.ML_DOMAIN}/search`,
                headers,
                method,
            ...
            const response = yield this.requestManager.schedule(request, 3);
            const $ = this.cheerio.load(response.data);
            return JapscanParsing_1.parseSearch($, metadata, UrlJapscan_1.ML_DOMAIN);
        });
    }
    getTags() {
        return __awaiter(this, void 0, void 0, function* () {
            ...
            const response = yield this.requestManager.schedule(request, 3);
            return JapscanParsing_1.parseTags(response.data);
        });
    }
    getHomePageSections(sectionCallback) {
        return __awaiter(this, void 0, void 0, function* () {
            ...
            const response = yield this.requestManager.schedule(request, 3);
            const $ = this.cheerio.load(response.data);
            JapscanParsing_1.parseHomeSections($, response.data, sectionCallback);
        });
    }
    globalRequestHeaders() {
        return {
            referer: UrlJapscan_1.ML_DOMAIN,
...
},{"./JapscanParsing":27,"./UrlJapscan":28,"paperback-extensions-common":4}],27:[function(require,module,exports){
"use strict";
Object.defineProperty(exports, "__esModule", { value: true });
...
exports.parseMangaDetails = ($, mangaId) => {
    ...
    const image = encodeURI(UrlJapscan_1.ML_DOMAIN + $('div[class="d-flex"] div img').attr('src'));
    ...
    $('p[class="mb-2"] span:contains("Statut:")').each(function (i, element) {
        ...
        status = body.replace(/\s+/g, "").includes('EnCours') ? paperback_extensions_common_1.MangaStatus.ONGOING : paperback_extensions_common_1.MangaStatus.COMPLETED;
    });
...
exports.parseChapters = (responseArray, mangaId) => {
    const chapters = [];
    console.log("test");
...
},{"./UrlJapscan":28,"paperback-extensions-common":4}],28:[function(require,module,exports){
"use strict";
Object.defineProperty(exports, "__esModule", { value: true });
exports.ML_DOMAIN = void 0;
exports.ML_DOMAIN = 'https://www.japscan.ws';
